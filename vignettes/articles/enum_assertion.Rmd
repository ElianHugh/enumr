...
If you are using [{typed}](https://moodymudskipper.github.io/typed/), you can make use of the `Enum` assertion for return and input assertion. Note that 'enum' is the class definition and 'Enum' is the assertion - this matches the {typed} paradigm of assertions.
